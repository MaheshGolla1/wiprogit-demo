...
class MovieForm extends Component {
    ...
    // it handle changes for all the fields
    handleChange = (e) => {
    ...
    // Handle form submit
    handleSubmit = (e) => {
        e.preventDefault(); //it prevents page reloading
        ...
        const platformsPretty = Object.entries(platforms)
            ...
            .join(" ");
        //it constructs one movie record
        const newMovie = {
            title,
            director,
            year,
        ...
        this.setState((prev) => ({
            movies: [...prev.movies, newMovie], //spread operator
            title: "",
            director: "",
            year: "",
            genre: "Action",
